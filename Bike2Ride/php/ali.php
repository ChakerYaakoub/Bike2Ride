...
$graphData = json_encode(['result1'=>$dataall,'result2'=>$databike,'result3'=>$dataAcc,'result4'=>$dataHel,'result5'=>$dataGlov,'result6'=>$dataBot]);
$graphData_decoded = json_decode($graphData);
echo $graphData;

// All Products count
$key1 = "result1";
$key2 = "ALLPRODUCT";
$allProducts1 = $graphData_decoded->$key1;
$allProductsCount = $allProducts1[0]->$key2;
echo $allProductsCount;

// Bike Products count
$key1 = "result2";
$key2 = "bikePRODUCT";
$allProducts1 = $graphData_decoded->$key1;
$bikeProductsCount = $allProducts1[0]->$key2;
echo $bikeProductsCount;

// echo json_encode($resultBot);
