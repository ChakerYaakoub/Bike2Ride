...
<div class="flex-nav">
    ...
    <div class="principal">
        <div class="col">
            ...
            <div class="container">
                <div class="row">
                    <!-- shop -->
                    <a href="accproduts.php?Category=bottle">
                    <div class="col-md-4 col-sm-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="bike\accessories\water.jfif" alt="">
                            </div>
                            <div style="opacity: 30px;" class="shop-body">
                                <h3>bike<br>Bottles</h3>
                    ...
                    <!-- shop -->
                    <a href="accproduts.php?Category=helmet">
                    <div class="col-md-4 col-sm-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="bike\accessories\helmit.jfif" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>Bike<br>Helmets</h3>
                                <a href="accproduts.html" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </a>
                    </div>
                    ...
                    <!-- shop -->
                    <a href="accproduts.php?Category=gloves">
                    <div class="col-md-4 col-sm-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="bike\accessories\images.jfif" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>Bike<br>Gloves</h3>
                                <a href="#" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
    ...
    <h4 style="padding-left:30px ;" class="section-title title">produts</h4>
        ...
        <div id="tab1" class="tab-pane active">
            <div class="products-slick" data-nav="#slick-nav-1">
                ...
                <div class="col-sm-5 col-md-3">
                    <!-- <a href="accproduts.html"> -->
                        <a href="echoHelmets.html">
                    <div class="product">
                        <div class="product-img">
                            <img src="bike\accessories\helmit\273719-00-d-548299.jpg"
                                alt="">
                ...
                <div class="col-sm-5 col-md-3">
                    ...
                    <div class="product">
                        <div class="product-img">
                            <img src="bike\accessories\helmit\fox-dropframe-pro-helmet-black4-857360.jpg"
                                alt="">
                            <div class="product-label">
                                <span class="new">NEW</span>
                            </div>
                ...
                <div class="col-sm-5 col-md-3">
                    ...
                    <div class="product">
                        <div class="product-img">
                            <img src="bike\accessories\gloves\336228-00-d-709870.jpg"
                                alt="">
                            <div class="product-label">
                                <span class="new">NEW</span>
                            </div>
                ...
                <div class="col-sm-5 col-md-3">
                    ...
                    <div class="product">
                        <div class="product-img">
                            <img src="bike\accessories\bolit\359000-00-d-772430.jpg"
                                alt="">
                        </div>
                        <div class="product-body">
                            <p class="product-category">Category</p>
                ...
                <div class="col-sm-5 col-md-3">
                    ...
                    <div class="product">
                        <div class="product-img">
                            <img src="bike\accessories\gloves\257021-00-d-508269.jpg"
                                alt="">
                        </div>
                        <div class="product-body">
                            <p class="product-category">Category</p>
