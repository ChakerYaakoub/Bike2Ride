...
//  echo $brandName;
 ...
 $querycat= "SELECT * FROM bikecategory WHERE categoryName = '$categoryName'";
 $resultcat = mysqli_query($conn, $querycat) or die( mysqli_error($conn));

 $rowcat=mysqli_fetch_array($resultcat) ;

$bikeCategory_descriptions= $rowcat['bikeCategory_descriptions'];
...
<body>
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul style="flex-direction: row;" class="main-nav nav navbar-nav">
                    ...
                    <li><a href="categories.php?categoryName=mountain">MOUNTAIN</a></li>
                    <li><a href="categories.php?categoryName=children">CHILDREN</a></li>
                    <li><a href="categories.php?categoryName=cross">CROSS</a></li>
                    <li><a href="categories.php?categoryName=city">CITY</a></li>
                    <li ><a href="categories.php?categoryName=triathlon">TRIATHLON</a></li>
                    <li><a href="categories.php?categoryName=road">ROAD</a></li>
                </ul>
                <!-- /NAV -->
            </div>
            <!-- /responsive-nav -->
    ...
    <div class="container">
        ...
        <h3 style="margin-top:50px;margin-left: 40px;text-transform: uppercase;"> <?php echo $categoryName ; ?></h3>
        
        <p  style="margin-left: 60px;"> <?php echo $bikeCategory_descriptions ; ?></p>
        <br><br><br>
...
<!-- 
    ...
    <script src="js/bikess.js"></script>
