...
?>
  ...
  <!-- Don't touch anything above!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
    ...
    <marquee direction="right">
        <span id="freedelivery" style="font-size: 50px;"> Welcome To BIKe<span1 class="span3">2</span1>RIDE</span>
        <img src="photo/bike.jpg" style="width: 90px; height: 60px; ">
    </marquee>
    <div class="div1">
        <div class="div3">
            <h2 style="font-size:30px  ; font-weight: bold;">Already Customer</h2><br>
            <p>Or use your email for registration</p>

            <form action="login.php" method="post">
                <input type="email" name="email" placeholder="Email" value="<?php echo $userEmail ?>" required> <br>
                <input type="password" name="password" placeholder="password " required>
                <br>
                <p style="color:red; font-size:12px;" > <b> <?php echo $passErr ;  ?> </b> </p>

                <p2 style="text-align:left;">Forgot your password?</p2><br><br>
                
                <button class="one" type="submit"> Log in</button><br><br>
                <button class="two" type="button"> <a href="signUp.php">
                        <span1 style="color:white"> Sigup</span1>
                    </a> </button>
