...
<body>
    ...
    <table>
        ...
        <tr>
            <td><img style="width:100px;" src="photo/cart-bike-test.png"></td>
            <td><p><span class="rb">Wilier</span><br>
                <span class="rb">Color:</span> white<br>
                <span class="rb">Size:</span> 24"</p>
            </td>
            <td class="special">Peugeot</td>
            <td>200$</td>
            <td>3</td>
            <td class="rb">600$</td>
            <td class="special"><input type="date" name="date" id="date"></td>
        </tr>
        <tr>
            <td>1</td>
            <td>2</td>
