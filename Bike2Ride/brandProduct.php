...
//  echo $brandName;
 $query = "SELECT * FROM product WHERE brandName = '$brandName'  ORDER BY RAND()";
 $result = mysqli_query($conn, $query) or die( mysqli_error($conn));




 $querybrand= "SELECT * FROM brands WHERE brandName = '$brandName'";
 $resultbrand = mysqli_query($conn, $querybrand) or die( mysqli_error($conn));

 $rowbrand=mysqli_fetch_array($resultbrand) ;

$brand_descriptions= $rowbrand['brand_descriptions'];
...
// $allData = $data;
// echo $allData;
// header('location:../brandProduct.php');     
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <nav class="bottom-navbare">
        ...
        <a href="home.php"> Home</a>
        <a style="color: rgb(75, 41, 41); font-weight: bolder; " href="bikes.php"> Bikes</a>
        <a href="accessories.php"> Accessories </a>
        <a href="brand.php"> Brand</a>
        <a href="about.html"> About</a>
        ...
        <div class="col-sm-12 col-md-12   ">
            ...
            <form action="" method="post">
                <div class=" col-md-12 myradio ">
                    ...
                    <input type="radio" name="cati" value="Helmit" id="maniBike"> <span>Helmit </span>
                    <input type="radio" name="cati" value="Bottes" id="maniBike"> <span>Bottes </span>
                    <input type="radio" name="cati" value="Gloves" id="maniBike"> <span>Gloves </span>
                </div>
                ...
                <select class="myfilterselect">
                    ...
                    <option value="Yellow">Grey</option>
                ...
                <div class=" col-md-12 ">
                    <button type="submit" class="fliterButton" value="My Filter">
                </div>
    ...
    <div class="container">
        ...
        <h3 style="margin-top:50px;margin-left: 40px;text-transform: uppercase;"> <?php echo $brandName ; ?></h3>
        
        <p  style="margin-left: 60px;"> <?php echo $brand_descriptions ; ?></p>
        <br><br><br>
...
<!-- 
    ...
    <script src="js/brandsPro.js"></script>
