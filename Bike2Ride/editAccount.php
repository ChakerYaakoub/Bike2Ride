...
<body>
    ...
    <body>
        ...
        <header class="header">
            ...
            <div class="header-1">
                ...
                <a href="home.php" class="logo"><i class="fa-solid fa-bicycle" style="color:rgb(46, 25, 46);"></i>
                    Bike<span class="span2">2</span>Ride</a>
                ...
                <form action="search.php" method="get" class="search-form" id="search">
                    ...
                    <button type="submit" class="fix" style="background: 0;  border: none !important; "><label
                            for="search-box" class="fas fa-search"></label>
                    </button>
                </form>
                <div class="icons">
        ...
        <div style="text-align:left; padding: 10px; text-align: left; margin-left: 15px;">
            <span class="span1"> Gender</span><br>
            <input type="radio" name="where" value="1" style="margin-left:40px ;" checked>
            <P3>Mr</P3>
        ...
        <form class="B row">
            <div>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="firstName" value="Hassan"><br>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="lastName" value="Najem"><br>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="E-mail" value="useremail.com"><br>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="phone nomber" value="+961......."><br>
            </div>
            <div>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="adress" value="Nabatieh"><br>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="code postal" value="4536"><br>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="Old password "><br>
                <img style="   width:20px;" src="photo/download.png">
                <input type="text" placeholder="new password"><br>
            </div>
            <div class="hover" style=" margin-top: 80px;">
                <button class="but1">Save</button>
                <br><br>
                <button class="but2">Delet Acount</button>
            </div>
            <div>
                <img class="img1" src="photo/bik.webp">
            </div>
        </form>
        <hr>
            ...
            <div class="box-container">
                <div class="box">
                    <h3 class="fotImage"> <i class="fa-solid fa-bicycle" style="color:rgb(46, 25, 46);"></i>
                        Bike<span class="span2">2</span>Ride
                    </h3>
                ...
                <div class="box">
                    <h3 class="fotImage">
                        Secure <span class="span2">p</span>ayments
                    </h3>
                    ...
                    <br> <br>
                    <h5 class="sm">
                        Since 2010 BIKE<span class="span3">2</span>RIDE <br>
