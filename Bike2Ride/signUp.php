...
?>
  ...
  <div style="text-align:center;">
      <p1>
          Create a new customer account by filling in the boxes below. Registration requires personal data.
          <span class="span4">BIKE2</span> shall not illicitly pass on personal data to third parties. In
          particular<span class="span4">BIKE2</span>
          shall not pass onany personal data to third parties for advertising purposes. For further information
          please visit the
          Privacy
  ...
  <div style="text-align:left; padding: 10px; text-align: left; margin-left: 15px;">
      ...
      <P3>M.</P3>
      <input type="radio" name="gender" value="female" required form="form1">
      <p3>Mme.</p3>
  </div>
  <form class="B row" action="registerPhp.php" method="post" id="form1">
