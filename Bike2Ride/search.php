...
if (isset($_GET['word'])) {
 ...
 `brandName` LIKE '%$word%'
  OR `title` LIKE '%$word%' 
  OR `material` LIKE '%$word%' 
  OR `made` LIKE '%$word%' 
  OR `categoryName` LIKE '%$word%' 
  OR `gender` LIKE '%$word%' 
...
OR title LIKE '%$word%'
OR descriptions LIKE '%$word%'
OR made LIKE '%$word%'
OR gender LIKE '%$word%'
OR material LIKE '%$word%'
OR model LIKE '%$word%'
OR categoryName LIKE '%$word%'
OR activity LIKE '%$word%'
...
<body>
    ...
    <div class="flex-nav">
        ...
        <div id="hov">
            <p> <a href="https://goo.gl/maps/So581tMAxw2yEuJA7" target="_blank" id="loc"><img src="photo/loc.webp" alt="" width="16px" height="16px" style="float: left;">11559 Ventura
    ...
    <header class="header">
        ...
        <div class="header-1">
            ...
            <form action="search.php" method="get" class="search-form" id="search">
                <input type="search" name="word" placeholder="search here..." id="search-box" value="<?php echo $word;?>">
    ...
    <div style="margin-left: 3%;">
       <p style="font-size:20px; font-weight:400;">  Showing 13 results for : </p>
       <p style="font-size:30px; font-weight: bold;">Willer</p>
    ...
    <div class="col-sm-6 col-md-4 text-center myfilterbikes">
        <div class="col-sm-12 col-md-12   ">
            <h3 style="text-align: left;padding-left: 10px;">Filters</h3>
            ...
            <form action="" method="post">
                ...
                <div class=" col-md-12">
                    <h5 style="margin-top: 20px;">Min price <input style="border: 10px;" type="number" id="priceMinNumber" class="hadiInputNumber" placeholder="100"></h5>
                </div>
                <div class=" col-md-12 ">
                    <h5 style="margin-top: 10px;">Max price<input type="number" id="priceMaxNumber" class="hadiInputNumber" placeholder="1000" onblur="checkminMaxprice()"></h5>
                </div>
                <div class=" col-md-12 ">
...
<div style="margin-left: 3%;">
   <p style="font-size:20px; font-weight:400;">  Showing <b> <?php echo mysqli_num_rows($result); ?> </b> results for : </p> <!-- for nb result-->
   <p style="font-size:30px; font-weight: bold;"><?php echo $word; ?></p>
...
if (mysqli_num_rows($result)==0) {
    // echo 'TRY ANOUTHER SEARCH';
    echo '<h3 style="margin-top:50px;margin-left: 40px;text-transform: uppercase;">TRY ANOUTHER SEARCH</h3>';
  ...
  <div class="product">
      ...
      <div class="product-body">
          ...
          <h4 style="padding-top: 7px;" class="product-price">$980.00
    ...
    <section class="footer">
        <div class="box-container">
            <div class="box">
                ...
                <p class="sm">
                    <a href="https://www.facebook.com/bikelebanon/" target="_blank"><i class="fa-brands fa-square-facebook"></i></a>
                    <a href="https://twitter.com/beirutbybike" target="_blank"> <i class="fa-brands fa-square-twitter"></i></a>
                    <a href="https://www.instagram.com/beirutbybike/" target="_blank"> <i class="fa-brands fa-square-instagram"></i></a>
            ...
            <div class="box">
                ...
                <h3 class="fotImage">
                    Secure <span style="color: rgb(179, 10, 10) ; font-weight: bold; font-size: larger; ">p</span>ayments
